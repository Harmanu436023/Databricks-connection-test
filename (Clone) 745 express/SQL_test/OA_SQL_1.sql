...
select
case when marketingairline in ('AA','US') then 'AA' when marketingairline in ('DL','NW') then 'DL' when marketingairline in ('WN','FL') then 'WN' else marketingairline end as carrier
...
where marketingairline in ('AA','US','DL','NW')
