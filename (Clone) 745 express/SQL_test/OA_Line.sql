select
case
  when marketingairline in ('aa','us') and origin not in ('clt','dca','dfw','jfk','lax','lga','mia','ord','phl','phx') and origincountry in ('US') then 'Line Dom'
  when marketingairline in ('aa','us') and origin not in ('clt','dca','dfw','jfk','lax','lga','mia','ord','phl','phx') and origincountry not in ('US') then 'Line Int'
...
where
marketingairline in ('aa','us','wn','dl','nw','b6','as','vx','f9','nk')
