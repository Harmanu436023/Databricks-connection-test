...
,Sum(case when ex_company_id = ' ' and r.CNXL_CD='C' and r.DIVERT_REASON_CD='  ' and left(r.CNXL_REASON_CD,1)<>'X' and  r.cnxl_reason_cd != 'nt' AND r.cnxl_reason_cd NOT IN ('NF') and r.cnxl_reason_cd not like 'z%' and  r.report_month = extract(month  From  current_date - 1)
