...
Select
case
when marketingairline in ('aa') then 'American'
...
Where  
marketingairline  in ('aa','dl','nw')
AND flightdate between DATE_FORMAT(CURDATE() - INTERVAL 7 DAY, '%Y%m01') and DATE_FORMAT(CURDATE() - INTERVAL 1 DAY, '%Y%m%d')
